defmodule ExampleUi.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      "assets.build": ["tailwind example_ui", "esbuild example_ui"],
      "assets.deploy": [
        "tailwind example_ui --minify",
        "esbuild example_ui --minify",
        "phx.digest"
      ]
    ]
  end
